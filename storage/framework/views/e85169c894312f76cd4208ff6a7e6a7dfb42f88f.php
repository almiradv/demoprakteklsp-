...
<?php $__env->startSection('content'); ?>
  <div class="container-fluid px-4">
      ...
      <?php echo $__env->make('modal.updateModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php $__currentLoopData = $get; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!--perulangan varriabel get dengan nama value-->
      ...
      <div class="card mb-4" style="margin-top:2%;">
          <embed src="<?php echo e(asset('file/'.$value->file->file)); ?>" type="application/pdf" width="100%" height="600px"> <!--menampilkan pdf-->
      </div>
        <a href="<?php echo e(route('home')); ?>" class="btn btn-secondary"><i class="fa fa-chevron-left" aria-hidden="true"></i> Kembali</a> <!--tombol kembali-->
        <a href="<?php echo e(asset('file/'.$value->file->file)); ?>" type="submit" class="btn btn-warning">Unduh</a> <!--tombol update-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bnsp\resources\views/show.blade.php ENDPATH**/ ?>