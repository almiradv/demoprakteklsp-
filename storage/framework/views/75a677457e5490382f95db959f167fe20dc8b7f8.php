  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo e(route('update.arsip')); ?>" method="post" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<?php /**PATH F:\xampp\htdocs\bnsp\resources\views/modal/updateModal.blade.php ENDPATH**/ ?>